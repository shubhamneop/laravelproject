     ...
     @endif
         ...
         <div class="row">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                      <th>#</th><th>Product</th><th>Description</th><th>Image</th><th>Category</th><th>Colour</th><th>Quantity</th><th>Action</th>
                      </tr>
                         ...
                         @foreach($products  as $product) 
                            <tr> <td>{{ $loop->iteration }}</td>
                             ...
                             <td> <img src="{{asset('product/' . $product->image->image_path )}}"  style="width:50px;height:70px;"></td>
                             ...
                             <td>{{$product->quantity}}</td>
                              ...
                              <td>
                                ...
                                <a href="{{ url('/admin/product/' . $product->id) }}" title="View configuration"><button class="btn btn-info "><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            ...
                                            @endcan
                                             @can('edit')
                                            <a href="{{ url('/admin/product/' . $product->c2_id . '/edit') }}" title="Edit configuration"><button class="btn btn-success "><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Sub </button></a>
                                            @endcan
